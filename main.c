...
int main() {
	...
	SDL_Texture* startButtonTexture = loadTexture(renderer, "buttons/start.bmp");
	SDL_Texture* exitButtonTexture = loadTexture(renderer, "buttons/quit.bmp");
	SDL_Texture* volumeOn = loadTexture(renderer, "buttons/vol1.bmp");
	SDL_Texture* volumeOff = loadTexture(renderer, "buttons/vol2.bmp");
